...
// import { Scrollbar } from "react-scrollbars-universal";
                  ...
                  <ListItem key={`item-${row.amount}-${row.position}`}>
                    ...
                    >
                      <Typography
                        variant="h6"
                        component="span"
                        style={{ color: "#8A6AE3", fontSize:25, fontWeight: 1000, marginLeft: 70}}
                      >
                        {row.success}
                      </Typography>
                      <Box
                      ...
                      >
                        <ListItemText className="list_top">
                          <Typography
                            variant="body1"
                            component="span"
                            style={{ color: '#6A58D1', fontSize:30, fontWeight:800, display: 'inline-block' }}
                          >
                            {row.name}
                          </Typography>
                          <Typography
                            style={{ fontSize:25, fontWeight:800, display: 'inline-block' }}
                          >
                            에게 오퍼를 보냈습니다
                          </Typography>
                        </ListItemText>
                        ...
                        <ListItemText
                          primary={
                            <Typography
                              variant="body1"
                              component="span"
                              style={{ color: '#6A58D1', fontSize: 18, fontWeight: 800 }}
                            >
                              관심 분야
                            </Typography>
                          }
                      ...
                      <Box sx={{ flexDirection: "column", width: "200px" }}>
                          <Button
                            className="buttons"
                            variant="contained"
                            style={{ width: "180px", backgroundColor: "#6A58D1", color: "white", fontSize: 18, fontWeight: 700, margin: "5px" }}
                          >
                            학생 상세보기
                          </Button>
                        </Box>
